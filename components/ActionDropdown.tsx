...
const ActionDropdown = ({ file }: { file: Models.Document }) => {
  ...
  const handleAction = async () => {
    ...
    //keyof and typeof is used to show that it can be three things of action (rename,delete and share)
          ...
          {actionsDropdownItems.map((actionItem) => (
            <DropdownMenuItem
              ...
              onClick={() => {
                ...
                //the drop down options shows diffrent modals which can used when click
                //on the options given to us were delete then delete confirmation etc
                if (["rename", "share", "delete", "details"].includes(actionItem.value)) {
                  setIsModalOpen(true);
                }
              }}
            >
              {/*This loads the label of the items we want to load*/}
